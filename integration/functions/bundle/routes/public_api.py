...
ROUTES = {
    ...
    "/integrations/followupboss/people/get":         ("followupboss", "people_get",         {"POST"}),
    "/integrations/followupboss/people/create":      ("followupboss", "people_create",      {"POST"}),
    "/integrations/followupboss/people/update":      ("followupboss", "people_update",      {"POST"}),
    "/integrations/followupboss/people/stage":       ("followupboss", "people_set_stage",   {"POST"}),
